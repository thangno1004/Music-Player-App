...
import com.pro.music.validator.addOrEditArtistValidator;
...
//            return;
//        }
        addOrEditArtistValidator.ArtistInputError inputError = addOrEditArtistValidator.validate(strName, strImage);
