...
import com.pro.music.validator.AddOrEditSongValidator;
...
public class AdminAddSongActivity extends BaseActivity {
    ...
    private void addOrEditSong() {
        ...
        AddOrEditSongValidator.SongInputError inputError = AddOrEditSongValidator.validate(strName, strImage, strUrl);
        switch (inputError) {
            case NAME_REQUIRED:
